...
public class BasePage extends GlobalConstants {
    ...
    protected By getLocator(String locator) {
        ...
        String typeLocator = locatorSplit[0];
        switch (typeLocator) {
            case "xpath":
            ...
            default:
                throw new RuntimeException("Not support thí type locator " + locatorSplit[1]);
        }
    }
...
//    }
    ...
    public List<WebElement> getListWebElements(WebDriver driver, String locator, String... params) {
        return driver.findElements(getLocator(getDynamiLocator(locator, params)));
    }
    ...
    public void scrollToHeaderPage(WebDriver driver) {
        jsExecutor = (JavascriptExecutor) driver;
        jsExecutor.executeScript("window.scrollBy(0,-document.body.scrollHeight)");
    }
...
//
    ...
    public void waitForElementVisible(WebDriver driver, String locator, String... params) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(longTimeOut));
        explicit.until(ExpectedConditions.visibilityOfElementLocated(getLocator(getDynamiLocator(locator, params))));
    }
    ...
    public void waitForElementToBeSelected(WebDriver driver, String locator, String... params) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(longTimeOut));
        explicit.until(ExpectedConditions.elementToBeSelected(getLocator(getDynamiLocator(locator, params))));
    }
    ...
    public void waitForElementClickable(WebDriver driver, String locator, String... params) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(longTimeOut));
        explicit.until(ExpectedConditions.elementToBeClickable(getLocator(getDynamiLocator(locator, params))));
    ...
    public void moveToElement(WebDriver driver, String locator) {
        ...
        actions.moveToElement(getWebElement(driver,locator)).build().perform();
    }
